      ...
      <div className="card-luxury">
        ...
        <div className="relative h-64 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex space-x-2">
            ...
            {property.featured && (
              <span className="px-3 py-1 text-xs font-semibold bg-luxury-charcoal text-white uppercase tracking-wider">
                Featured
              </span>
            )}
          </div>
          ...
          {/* Verified Badge */}
          {property.verified && (
            <div className="absolute top-3 right-12 flex items-center space-x-1 bg-luxury-charcoal/90 px-2 py-1 rounded">
          ...
          <button
            onClick={handleSave}
            className="absolute top-3 right-3 p-2 bg-luxury-charcoal/90 rounded-full hover:bg-luxury-gold transition-colors"
          >
        ...
        <div className="p-5">
          <div className="flex items-start justify-between mb-3">
            <h3 className="font-display text-lg font-semibold text-white group-hover:text-luxury-gold transition-colors line-clamp-1">
              {property.title}
            </h3>
          </div>
          ...
          <div className="flex items-center text-luxury-textMuted text-sm mb-4">
            ...
            <span className="truncate">{property.location.subCity}, {property.location.city}</span>
          </div>
          ...
          <div className="pt-4 flex items-center justify-between">
            ...
            <span className="text-xs text-luxury-textMuted uppercase tracking-wider">
